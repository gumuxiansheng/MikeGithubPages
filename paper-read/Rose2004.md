...
<i><font color=red size=4>But should we-and the protestors-really care about the WTO at all? Do we really know that the WTO and its predecessor the General Agreement on Tariffs and Trade (GATT) have actually promoted trade?</font></i>
...
<font color=red size=4>Why economists have assumed that the GATT has been so important in encouraging trade?</font>
